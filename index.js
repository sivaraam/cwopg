 ...
 */
const articleListFileName = 'articleList';
...
const generatePackage = function (params, packageCallback) {
    ...
    const articleListCallback = function () {
        packageGenerator.generateZimPackage (articleListFile,
                                            zimOutputDir,
                                            packageOptions,
    ...
    try {
        categoryListGenerator.generateCategoryList (params.userQuery,
                                                    enwikiCatsFile,
...
module.exports.generatePackage = generatePackage;
